...
class AdobeSignTest extends BaseTestCase
{
    ...
    {
        $this->expectException('Zxurian\AdobeSign\Exceptions\AdobeSignInvalidAccessTokenException');
    ...
    {
        $this->expectException('Zxurian\AdobeSign\Exceptions\AdobeSignUnsupportedMediaTypeException');
    ...
    {
        $this->expectException('Zxurian\AdobeSign\Exceptions\AdobeSignMissingRequiredParamException');
